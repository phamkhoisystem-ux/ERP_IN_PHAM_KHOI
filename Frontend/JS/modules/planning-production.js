...
function loadEditPlan(idSX) {
    ...
    function renderKeHoach() {
        ...
        function inPhieuKeHoach(idSX) {
            ...
            host.className = 'production-print';
            host.innerHTML = '<header class="receipt-header"><div class="receipt-company"><img src="assets/logo-pk.svg" alt="Phạm Khôi" class="receipt-logo"><div>Địa chỉ: 119/24 Nguyễn Văn Cừ, P.2, Q.5, HCM</div><div>SĐT: 0906 9000 21</div></div><div class="receipt-form-note"><b>PHẠM KHÔI ERP</b><br><i>Phiếu kế hoạch sản xuất / thương mại</i></div></header><section class="receipt-title"><h2>' + title + '</h2></section><div class="production-document-number">Số phiếu: <span>' + safe(kh.idSX) + '</span></div><section class="production-meta"><b>Ngày lập</b><span>' + formatDate(kh.date) + '</span><b>Hạn giao</b><span>' + formatDate(kh.deadline) + '</span><b>Tên đơn hàng</b><strong class="production-meta-wide">' + safe(kh.baiIn) + '</strong><b>Ghi chú</b><span class="production-meta-wide">' + safe(kh.ten || '—') + '</span></section><h3>' + detailTitle + '</h3>' + commercialDetail.replace('font-size:17px;font-weight:bold;margin:16px 0;', 'font-size:12px;font-weight:bold;margin:7px 0;') + '<div class="receipt-signatures"><div><b>Người lập phiếu</b><br><i>(Ký, họ tên)</i></div><div><b>Phụ trách sản xuất</b><br><i>(Ký, họ tên)</i></div><div><b>Giám đốc</b><br><i>(Ký, họ tên, đóng dấu)</i></div></div>';
